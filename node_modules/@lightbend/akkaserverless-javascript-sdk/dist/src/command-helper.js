...
class CommandHelper {
    ...
    handleCommand(command) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const reply = yield this.handleCommandLogic(command);
            ...
            if (!this.service.methods.hasOwnProperty(command.name)) {
                ...
                try {
                    ...
                    if (handler !== null) {
                        ...
                        const reply = yield this.invokeHandlerLogic(() => handler(deserCommand, ctx), ctx, grpcMethod, 'Command');
    ...
    invoke(handler, ctx) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let userReply = null;
            try {
                userReply = yield Promise.resolve(handler());
            }
            catch (err) {
                if (ctx.error === null) {
    ...
    invokeHandlerLogic(handler, ctx, grpcMethod, desc) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const userReply = yield this.invoke(handler, ctx);
            if (ctx.error !== null) {
                ...
                if (userReply.failure) {
                    ...
                    if (userReply.effects) {
                        ctx.reply.sideEffects = userReply.effects.map((effect) => this.effectSerializer.serializeSideEffect(effect.method, effect.message, effect.synchronous, effect.metadata));
                    }
                    if (userReply.message) {
                        ...
                        ctx.reply.clientAction = {
                            forward: this.effectSerializer.serializeEffect(userReply.forward.method, userReply.forward.message, userReply.forward.metadata),
                        };
