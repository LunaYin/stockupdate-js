...
class ReplicatedEntityServices {
    ...
    register(server) {
        ...
        const entityService = grpcDescriptor.akkaserverless.component.replicatedentity
    ...
    handle(call) {
        ...
        call.on('data', (replicatedEntityStreamIn) => {
            ...
            replicatedEntityStreamIn =
                protoHelper.moduleRoot.akkaserverless.component.replicatedentity.ReplicatedEntityStreamIn.fromObject(replicatedEntityStreamIn);
            if (replicatedEntityStreamIn.init) {
                if (service != null) {
                    ...
                    call.write({
                        failure: {
                            description: "Replicated Entity service '" +
...
class ReplicatedEntityHandler {
    ...
    commandHandlerFactory(commandName, grpcMethod) {
        if (this.entity.commandHandlers.hasOwnProperty(commandName)) {
            return (command, ctx) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const userReply = yield this.entity.commandHandlers[commandName](command, ctx.context);
                if (ctx.streamed && ctx.subscription === null) {
                    // todo relax this requirement
                    throw new Error('Streamed commands must be subscribed to using ctx.subscribe()');
                }
                yield this.setStateActionOnReply(ctx);
                if (ctx.subscribed) {
    ...
    onData(replicatedEntityStreamIn) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                yield this.handleReplicatedEntityStreamIn(replicatedEntityStreamIn);
            }
            catch (err) {
    ...
    handleStateChange() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield Promise.all(Array.from(this.subscribers).map((sub, k) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                const key = sub[0];
                ...
                try {
                    ...
                    const msg = yield this.commandHelper.invokeHandlerLogic(handler, ctx, subscriber.grpcMethod);
    ...
    handleReplicatedEntityStreamIn(replicatedEntityStreamIn) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (replicatedEntityStreamIn.delta && this.currentState === null) {
                yield this.handleInitialDelta(replicatedEntityStreamIn.delta);
            }
                ...
                yield this.commandHelper.handleCommand(replicatedEntityStreamIn.command);
            }
            else if (replicatedEntityStreamIn.streamCancelled) {
                yield this.handleStreamCancelled(replicatedEntityStreamIn.streamCancelled);
            }
            else {
                this.call.write({
                    failure: {
...
//# sourceMappingURL=replicated-entity-support.js.map