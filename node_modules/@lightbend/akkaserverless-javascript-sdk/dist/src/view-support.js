        ...
        call.on('data', (viewStreamIn) => {
            ...
            if (viewStreamIn.receive) {
                ...
                if (service) {
                    ...
                    if (updateHandler) {
                        try {
                            const anySupport = new AnySupport(service.root), metadata = new Metadata(receiveEvent.metada ? receiveEvent.metadata.entries : []), payload = anySupport.deserialize(receiveEvent.payload), existingState = receiveEvent.bySubjectLookupResult
