...
declare module "@lightbend/akkaserverless-javascript-sdk" {
    ...
    namespace AkkaServerless {
        ...
        type options = {
            /**
             * <p>[serviceName=<name from package.json>] The name of this service.</p>
             */
            serviceName: string;
            /**
             * <p>[serviceVersion=<version from package.json>] The version of this service.</p>
             */
            serviceVersion: string;
            /**
             * <p>[descriptorSetPath=&quot;user-function.desc&quot;] A path to a compiled Protobuf FileDescriptor set,
    ...
    namespace replicatedentity {
        ...
        class ReplicatedEntity implements Entity {
             ...
             */
            lookupType(messageType: string): void;
            register(allComponents: any): ReplicatedEntityServices;
        }
    }
